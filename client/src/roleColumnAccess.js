export const ROLE_COLUMN_ACCESS_OPTIONS = [
  ...
  { key: 'carpenter', label: 'Столяр', description: 'Работа столярного этапа.', primaryColumnIndex: 11, widthVar: '--orders-col-carpenter-width' },
  { key: 'materialRequests', label: 'Заявки на расходники', description: 'Заявки на расходники по изделию с чекбоксами исполнения.', primaryColumnIndex: 12, widthVar: '--orders-col-material-requests-width' },
  { key: 'paint', label: 'Покраска', description: 'Работа по покраске и файлы покраски.', primaryColumnIndex: 13, widthVar: '--orders-col-paint-width' },
  { key: 'itemStartDate', label: 'Начало изготовления изделия', description: 'Дата начала изготовления изделия.', primaryColumnIndex: 14, widthVar: '--orders-col-meta-width' },
  { key: 'itemEndDate', label: 'Окончание изготовления изделия', description: 'Дата окончания изготовления изделия.', primaryColumnIndex: 15, widthVar: '--orders-col-meta-width' },
  { key: 'itemDuration', label: 'Время изготовления изделий', description: 'Длительность изготовления конкретного изделия.', primaryColumnIndex: 16, widthVar: '--orders-col-meta-width' },
  { key: 'duration', label: 'Время изготовления заказа', description: 'Сводная длительность изготовления заказа.', primaryColumnIndex: 17, widthVar: '--orders-col-meta-width' },
];
