...
export function openTelegramQrScanner({ onSuccess, onError, onStatusChange } = {}) {
  ...
  if (!webApp || typeof webApp.showScanQrPopup !== 'function') {
    onError?.('¦á¦¦¦-¦-¦¬TÀ¦-¦-¦-¦-¦¬¦¦ ¦+¦-TÁTÂTÃ¦¬¦-¦- TÂ¦-¦¬TÌ¦¦¦- ¦- ¦¬TÀ¦¬¦¬¦-¦¦¦¦¦-¦¬¦¬ Telegram ¦-¦- ¦¬¦-¦+¦+¦¦TÀ¦¦¦¬¦-¦-¦¦¦-¦-¦- TÃTÁTÂTÀ¦-¦¦TÁTÂ¦-¦¦.');
    return false;
  }

  onError?.('');
  onStatusChange?.('¦Ý¦-¦-¦¦¦+¦¬TÂ¦¦ ¦¦¦-¦-¦¦TÀTÃ ¦-¦- QR-¦¦¦-¦+ ¦¬¦-¦¦¦-¦¬¦-.');
  ...
  webApp.showScanQrPopup(
    ...
    (scannedText) => {
      ...
      if (!orderPath) {
        onError?.('QR-¦¦¦-¦+ ¦-¦¦ TÀ¦-TÁ¦¬¦-¦¬¦-¦-¦-. ¦ØTÁ¦¬¦-¦¬TÌ¦¬TÃ¦¦TÂ¦¦ QR-¦¦¦-¦+ ¦¬¦-¦¦¦-¦¬¦-, TÁ¦¦¦¦¦-¦¦TÀ¦¬TÀ¦-¦-¦-¦-¦-TË¦¦ ¦- TÁ¦¬TÁTÂ¦¦¦-¦¦.');
        return false;
      }
      ...
      onStatusChange?.('¦ÞTÂ¦¦TÀTË¦-¦-TÎ TÁTÂTÀ¦-¦-¦¬TÆTÃ ¦¬¦-¦¦¦-¦¬¦-...');
      onSuccess?.(orderPath);
      return true;
    }
  );
